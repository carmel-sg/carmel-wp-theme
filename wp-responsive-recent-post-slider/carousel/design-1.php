...
<div class="wppsac-carousel-slides">
	...
	<div class="wppsac-post-content-position">
		...
		<?php if( $showContent ) {  ?>
			<div class="wppsac-post-content wp-block-button has-custom-font-size is-style-outline common-btn has-normal-font-size">
				<?php
				...
				<?php } ?>
				<?php if( $showreadmore ) { ?>
					<a class="wppsac-readmorebtn wp-block-button__link has-white-color has-text-color" href="<?php the_permalink(); ?>"><?php _e('Read More', 'wp-responsive-recent-post-slider'); ?></a>
				<?php } ?>
			</div>
		<?php } ?>
	</div>
